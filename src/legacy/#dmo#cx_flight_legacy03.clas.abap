CLASS /dmo/cx_flight_legacy03 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_03',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_03',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id03 OPTIONAL
        booking_id            TYPE /dmo/booking_id03 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id03 OPTIONAL
        agency_id             TYPE /dmo/agency_id03 OPTIONAL
        customer_id           TYPE /dmo/customer_id03 OPTIONAL
        carrier_id            TYPE /dmo/carrier03-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_03-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_03-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date03 OPTIONAL
        end_date              TYPE /dmo/end_date03 OPTIONAL
        booking_date          TYPE /dmo/booking_date03 OPTIONAL
        flight_date           TYPE /dmo/flight_date03 OPTIONAL
        status                TYPE /dmo/travel_status03 OPTIONAL
        currency_code         TYPE /dmo/currency_code03 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id03,
          mv_booking_id            TYPE /dmo/booking_id03,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id03,
          mv_agency_id             TYPE /dmo/agency_id03,
          mv_customer_id           TYPE /dmo/customer_id03,
          mv_carrier_id            TYPE /dmo/carrier03-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_03-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_03-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date03,
          mv_end_date              TYPE /dmo/end_date03,
          mv_booking_date          TYPE /dmo/booking_date03,
          mv_flight_date           TYPE /dmo/flight_date03,
          mv_status                TYPE /dmo/travel_status03,
          mv_currency_code         TYPE /dmo/currency_code03,
...
CLASS /dmo/cx_flight_legacy03 IMPLEMENTATION.
