@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U03'
...
define view /DMO/I_BookingSupplement_U03
  as select from /dmo/book_sup_03 as BookingSupplement

  association        to parent /DMO/I_Booking_U03  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement03     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement03Text03 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT03', element: 'SupplementID' },
