@AbapCatalog.sqlViewName: '/DMO/ITRAV_U03'
...
define root view /DMO/I_Travel_U03
  as select from /dmo/travel03 as Travel -- the travel table is the data source for this view

  composition [0..*] of /DMO/I_Booking_U03 as _Booking

  association [0..1] to /DMO/I_Agency03       as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to /DMO/I_Customer03     as _Customer  on $projection.CustomerID      = _Customer.CustomerID
...

{
    ...
    @Consumption.valueHelpDefinition: [{ entity : {name: '/DMO/I_Agency03', element: 'AgencyID'  } }]
