@AbapCatalog.sqlViewName: '/DMO/ICONNE_R03'
...
define view /DMO/I_Connection_R03
  as select from /dmo/connecti_03 as Connection

  association [1..*] to /DMO/I_Flight_R03 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier03  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport03',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
